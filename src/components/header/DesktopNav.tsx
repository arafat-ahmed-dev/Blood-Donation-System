        ...
        <nav className="hidden md:flex" aria-label="Main navigation">
            <NavigationMenu>
                <NavigationMenuList>
                    ...
                    <NavigationMenuItem>
                        ...
                        <NavigationMenuContent>
                            <ul className="grid gap-3 p-6 w-[400px] md:grid-cols-2" role="menu">
                                <li role="menuitem">
                                    <NavigationMenuLink asChild>
                                        <Link href="/request" className="block select-none space-y-1 rounded-md p-3 hover:bg-accent transition-colors">
                                ...
                                <li role="menuitem">
                                    <NavigationMenuLink asChild>
                                        <Link href="/donor/list" className="block select-none space-y-1 rounded-md p-3 hover:bg-accent transition-colors">
                                ...
                                <li className="col-span-2" role="menuitem">
                                    <NavigationMenuLink asChild>
                                        <Link href="/blood-bank" className="block select-none space-y-1 rounded-md p-3 hover:bg-accent transition-colors">
                    ...
                    <NavigationMenuItem>
                        ...
                        <NavigationMenuContent>
                            <ul className="grid gap-3 p-6 w-[400px] md:w-[500px] md:grid-cols-2" role="menu">
                                <li role="menuitem">
                                    <NavigationMenuLink asChild>
                                        <Link href="/become-blood-donor" className="block select-none space-y-1 rounded-md p-3 hover:bg-accent transition-colors">
                                ...
                                <li role="menuitem">
                                    <NavigationMenuLink asChild>
                                        <Link href="/blog" className="block select-none space-y-1 rounded-md p-3 hover:bg-accent transition-colors">
                                ...
                                <li role="menuitem">
                                    <NavigationMenuLink asChild>
                                        <Link href="/donation-centers" className="block select-none space-y-1 rounded-md p-3 hover:bg-accent transition-colors">
                                ...
                                <li role="menuitem">
                                    <NavigationMenuLink asChild>
                                        <Link href="/education" className="block select-none space-y-1 rounded-md p-3 hover:bg-accent transition-colors">
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuLink asChild>
                            <Link href="/about" className="px-3 py-2 text-sm font-medium rounded-md hover:bg-accent transition-colors">
                                About
                            </Link>
                        </NavigationMenuLink>
                    </NavigationMenuItem>
